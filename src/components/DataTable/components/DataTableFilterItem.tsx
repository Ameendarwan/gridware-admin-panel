...
import { dataTableConfig, DataTableFilterOption } from '@app/components/DataTable/DataTable.types';
...
import DataTableAdvancedFacetedFilter from '@app/components/DataTable/components/DataTableAdvancedFacetedFilter';
