...
import { DataTableFilterOption, Option } from '@app/components/DataTable/data-table.types';
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
const DataTableAdvancedFacetedFilter = <TData, TValue>({
  column,
  title,
  options,
  selectedValues,
...
export default DataTableAdvancedFacetedFilter;
